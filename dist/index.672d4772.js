...
const contactBtn = document.querySelector(".section__home-description--buttons--contact");
...
const handleHover = function(e) {
    if (e.target.classList.contains("header__navigation-item")) {
        const link = e.target;
        const siblings = link.closest(".header__navigation").querySelectorAll(".header__navigation-item");
        const logo = link.closest(".header").querySelector(".header__logo");
        const btn = link.closest(".header__navigation").querySelector(".header__navigation-button");
        siblings.forEach((el)=>{
...
const footerHover = function(e) {
    if (e.target.classList.contains("footer__link")) {
        const link = e.target;
        const siblings = link.closest(".footer__links").querySelectorAll(".footer__link");
        siblings.forEach((el)=>{
            if (el !== link) el.style.opacity = this;
        });
    }
